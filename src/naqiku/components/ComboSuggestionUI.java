...
public class ComboSuggestionUI extends BasicComboBoxUI {
    ...
    public void installUI(JComponent jc) {
        ...
        txt.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent fe) {
                border.setColor(new Color(255, 235, 204));
            }
        ...
        comboBox.addPopupMenuListener(new PopupMenuListener() {
            ...
            public void popupMenuWillBecomeVisible(PopupMenuEvent pme) {
                arrowButton.setBackground(new Color(255, 235, 204));
            }

            @Override
            public void popupMenuWillBecomeInvisible(PopupMenuEvent pme) {
                arrowButton.setBackground(new Color(255, 107, 107));
            }
    ...
    private class ArrowButton extends JButton {
        ...
        public ArrowButton() {
            ...
            setBackground(new Color(255, 107, 107));
        }
