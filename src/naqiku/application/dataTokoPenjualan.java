 ...
 * @author Susa
 */
public class dataTokoPenjualan extends javax.swing.JFrame {

    /**
     * Creates new form dataTokoPenjualan
     */
    public dataTokoPenjualan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        frameBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/naqiku.frames/Data Toko Penjualan.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dataTokoPenjualan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dataTokoPenjualan().setVisible(true);
            }
        });
    }
