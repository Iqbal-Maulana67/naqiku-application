 ...
 * @author Susa
 */
public class dataTokoKeuntungan extends javax.swing.JFrame {

    /**
     * Creates new form dataToko
     */
    public dataTokoKeuntungan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        frameBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/naqiku.frames/Data Toko.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dataTokoKeuntungan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dataTokoKeuntungan().setVisible(true);
            }
        });
    }
